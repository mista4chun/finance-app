...
function PageNavMobile() {
  return (
    <nav className="h-16 md:h-24 flex items-center justify-evenly rounded-t-lg bg-[#201f24] lg:hidden">
      <NavLink
        to="/overview"
        className={({ isActive }) =>
          isActive
            ? "mt-1 flex flex-col items-center gap-2 rounded-t-md border-b-4 border-[#277c78] bg-gray-200 px-7 py-3.5 transition-all duration-150 md:flex md:rounded-t-xl md:px-7 md:py-5"
            : "flex flex-col items-center gap-2 px-7 py-3.5 transition-all duration-150 md:flex md:rounded-t-xl md:px-7 md:py-5"
        }
      >
        {({ isActive }) => (
          <>
            ...
            <span
              className={
                isActive
                  ? "hidden text-xs font-semibold text-black md:block"
                  : "hidden text-xs font-semibold text-[#b3b3b3] md:block"
              }
            >
              Overview
            </span>
      ...
      <NavLink
        ...
        className={({ isActive }) =>
          isActive
            ? "mt-1 flex flex-col items-center gap-2 rounded-t-md border-b-4 border-[#277c78] bg-gray-200 px-7 py-3.5 transition-all duration-150 md:flex md:rounded-t-xl md:px-5 md:py-5"
            : "flex flex-col items-center gap-2 px-7 py-3.5 transition-all duration-150 md:flex md:rounded-t-xl md:px-5 md:py-5"
        }
      >
        {({ isActive }) => (
          <>
      ...
      <NavLink
        ...
        className={({ isActive }) =>
          isActive
            ? "mt-1 flex flex-col items-center gap-2 rounded-t-md border-b-4 border-[#277c78] bg-gray-200 px-7 py-3.5 transition-all duration-150 md:flex md:rounded-t-xl md:px-8 md:py-5"
            : "flex flex-col items-center gap-2 px-7 py-3.5 transition-all duration-150 md:flex md:rounded-t-xl md:px-8 md:py-5"
        }
      >
        {({ isActive }) => (
          <>
      ...
      <NavLink
        ...
        className={({ isActive }) =>
          isActive
            ? "mt-1 flex flex-col items-center gap-2 rounded-t-md border-b-4 border-[#277c78] bg-gray-200 px-7 py-3.5 transition-all duration-150 md:flex md:rounded-t-xl md:px-11 md:py-5"
            : "flex flex-col items-center gap-2 px-7 py-3.5 transition-all duration-150 md:flex md:rounded-t-xl md:px-11 md:py-5"
        }
      >
        {({ isActive }) => (
          <>
